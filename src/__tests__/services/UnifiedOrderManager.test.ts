...
describe('UnifiedOrderManager', () => {
  ...
  beforeEach(() => {
    ...
    OrderManagementSystem.prototype.getPositionsBySymbol = jest.fn().mockImplementation((symbol: string) => {
      if (symbol === 'SOL/USDT') {
        return [{
          symbol: 'SOL/USDT',
          side: OrderSide.BUY,
    ...
    OrderManagementSystem.prototype.cancelOrder = jest.fn().mockImplementation((orderId: string) => {
