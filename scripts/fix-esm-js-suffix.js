 ...
 * 
 * 使用方法:
 *  node scripts/fix-esm-js-suffix.js [コマンド] [ディレクトリ]
 * 
 * コマンド:
 ...
 * 
 * 例:
 *  node scripts/fix-esm-js-suffix.js check src        # src配下の修正候補をリストアップ
 *  node scripts/fix-esm-js-suffix.js check-fix src    # src配下を安全に修正
 */
...
const CHECK_SCRIPT = path.join(TOOLS_DIR, 'fix-js-suffix.js');
const FIX_SCRIPT = path.join(TOOLS_DIR, 'fix-js-suffix-apply.js');
